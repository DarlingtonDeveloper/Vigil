...
async def _seed_risk_factors():
    ...
    factors = [
        {"name": "autonomy_level", "category": "technical", "description": "How much independent action the agent can take without human approval", "measurement": "Classify as: fully_autonomous, human_on_the_loop, human_in_the_loop, human_in_command", "weight": 0.9, "levels": [{"level": "human_in_command", "score": 0.1, "criteria": "Human makes all decisions, agent only suggests"}, {"level": "human_in_the_loop", "score": 0.3, "criteria": "Agent proposes, human approves each action"}, {"level": "human_on_the_loop", "score": 0.6, "criteria": "Agent acts, human monitors and can intervene"}, {"level": "fully_autonomous", "score": 1.0, "criteria": "Agent acts without any human oversight"}]},
        {"name": "tool_permissions", "category": "technical", "description": "What external systems and actions the agent can invoke", "measurement": "Enumerate tools: read-only APIs, write APIs, financial transactions, email/comms, code execution", "weight": 0.85, "levels": [{"level": "read_only", "score": 0.1, "criteria": "Agent can only read data, no write actions"}, {"level": "internal_write", "score": 0.3, "criteria": "Agent can modify internal records"}, {"level": "external_communication", "score": 0.6, "criteria": "Agent can send emails, messages, or make representations to third parties"}, {"level": "financial_transactional", "score": 0.9, "criteria": "Agent can execute payments, trades, or enter binding commitments"}]},
        {"name": "data_access_scope", "category": "technical", "description": "What data the agent can access — PII, financial, health, privileged", "measurement": "Classify data types accessible: public, internal, PII, financial, health, privileged/legal", "weight": 0.7, "levels": [{"level": "public_only", "score": 0.1, "criteria": "Only public data"}, {"level": "internal_non_sensitive", "score": 0.3, "criteria": "Internal data without PII or regulated categories"}, {"level": "pii_financial", "score": 0.7, "criteria": "Personal data or financial records"}, {"level": "health_legal_privileged", "score": 1.0, "criteria": "Health records, legal privilege, or classified data"}]},
        {"name": "output_reach", "category": "technical", "description": "Who sees or relies on the agent's outputs", "measurement": "Classify: internal_only, customer_facing, public_facing, legally_binding", "weight": 0.8, "levels": [{"level": "internal_only", "score": 0.1, "criteria": "Outputs seen only by internal staff"}, {"level": "customer_facing", "score": 0.5, "criteria": "Outputs seen by customers or partners"}, {"level": "public_facing", "score": 0.7, "criteria": "Outputs visible to the general public"}, {"level": "legally_binding", "score": 1.0, "criteria": "Outputs constitute legal commitments, contracts, or regulatory filings"}]},
        {"name": "hallucination_risk", "category": "technical", "description": "Probability the agent produces factually incorrect outputs that are acted upon", "measurement": "Based on: model eval scores, domain specificity, output validation, structured output enforcement", "weight": 0.75, "levels": [{"level": "minimal", "score": 0.1, "criteria": "Structured outputs, validated against schema, domain-constrained"}, {"level": "moderate", "score": 0.4, "criteria": "Free-form text with some validation"}, {"level": "high", "score": 0.7, "criteria": "Free-form generation with no output validation"}, {"level": "critical", "score": 1.0, "criteria": "Agent generates claims about facts (medical, legal, financial) without source grounding"}]},
        {"name": "scope_creep_potential", "category": "technical", "description": "How likely the agent is to drift into unintended high-risk use cases at runtime", "measurement": "Based on: breadth of agent mandate, tool diversity, prompt openness", "weight": 0.65, "levels": [{"level": "constrained", "score": 0.1, "criteria": "Single-purpose agent with narrow tools and fixed prompts"}, {"level": "moderate", "score": 0.4, "criteria": "Multi-purpose but within a defined domain"}, {"level": "broad", "score": 0.7, "criteria": "General-purpose assistant with diverse tools"}, {"level": "unbounded", "score": 1.0, "criteria": "Open-ended agent that determines its own sub-tasks and tool usage"}]},
        {"name": "jurisdiction_risk", "category": "legal_exposure", "description": "How favorable or unfavorable the legal jurisdiction is for AI deployment", "measurement": "Based on: regulatory maturity, litigation culture, precedent clarity", "weight": 0.7, "levels": [{"level": "favorable", "score": 0.2, "criteria": "Jurisdiction with clear AI-friendly regulation and limited litigation risk"}, {"level": "moderate", "score": 0.5, "criteria": "Jurisdiction with emerging regulation, some precedent"}, {"level": "unfavorable", "score": 0.8, "criteria": "Jurisdiction with strict regulation, active enforcement, high litigation culture"}, {"level": "multi_jurisdiction", "score": 1.0, "criteria": "Agent operates across multiple jurisdictions with conflicting requirements"}]},
        {"name": "precedent_clarity", "category": "legal_exposure", "description": "How clear the law is on AI agent liability in this deployment context", "measurement": "Based on: existing case law, statutory clarity, regulatory guidance", "weight": 0.6, "levels": [{"level": "clear", "score": 0.2, "criteria": "Well-established precedent directly applicable"}, {"level": "analogous", "score": 0.5, "criteria": "Existing precedent can be applied by analogy"}, {"level": "untested", "score": 0.8, "criteria": "No directly applicable precedent, outcome unpredictable"}, {"level": "conflicting", "score": 1.0, "criteria": "Conflicting signals from different jurisdictions or courts"}]},
        {"name": "vendor_indemnification", "category": "legal_exposure", "description": "Whether the AI vendor provides meaningful indemnification for agent failures", "measurement": "Review vendor contract terms for indemnification, liability caps, disclaimers", "weight": 0.5, "levels": [{"level": "full_indemnity", "score": 0.1, "criteria": "Vendor provides full indemnification for AI-related claims"}, {"level": "partial", "score": 0.4, "criteria": "Vendor provides limited indemnification with caps"}, {"level": "minimal", "score": 0.7, "criteria": "Vendor disclaims most liability, low caps"}, {"level": "none", "score": 1.0, "criteria": "No indemnification, broad disclaimers, liability shifted entirely to deployer"}]},
        {"name": "sector_sensitivity", "category": "market", "description": "How sensitive the deployment sector is from a regulatory and public perception standpoint", "measurement": "Classify sector: low-sensitivity (internal tools), medium (B2B services), high (financial, healthcare, legal, education, employment)", "weight": 0.6, "levels": [{"level": "low", "score": 0.1, "criteria": "Internal productivity tools, no regulated data"}, {"level": "medium", "score": 0.4, "criteria": "B2B services, commercial applications"}, {"level": "high", "score": 0.7, "criteria": "Financial services, legal, education"}, {"level": "critical", "score": 1.0, "criteria": "Healthcare, employment decisions, law enforcement, critical infrastructure"}]},
    ]
    for f in factors:
