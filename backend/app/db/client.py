...
class SurrealClient:
    def __init__(self):
        self._url = settings.surreal_url
        self._namespace = settings.surreal_ns
        self._database = settings.surreal_db
        self._username = settings.surreal_user
        self._password = settings.surreal_pass
